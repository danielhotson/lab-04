...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("dhotson/ipinfo")
    client.subscribe("dhotson/dateinfo")
    client.subscribe("dhotson/timeinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("dhotson/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("dhotson/dateinfo", on_message_from_dateinfo)
    client.message_callback_add("dhotson/timeinfo", on_message_from_timeinfo)
