...
if __name__ == '__main__':
    ...
    while True:
        ...
        client.publish("dhotson/ipinfo", f"{ip_address}")
        ...
        timeinfo = datetime.now().time()
        
        
        
        #publish date and time in their own topics
        """your code here"""
        client.publish("dhotson/dateinfo", f"{dateinfo}")
        print("Publishing date")
        time.sleep(4)
        
        client.publish("dhotson/timeinfo", f"{timeinfo}")
